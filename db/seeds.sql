...
INSERT INTO `orders`(`id`, `store_name`, `route_id`, `number_of_items`, `number_of_boxes`, `vehicles_id`, `status`, `created_at`, `updated_at`) VALUES ('[value-1]','[value-2]','[value-3]','[value-4]','[value-5]','[value-6]','[value-7]','[value-8]','[value-9]')